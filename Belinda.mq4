...
//|                                                                  |
//|   Modified by Lucas Liew & Torry Yang                            |                                                                 
//|                                                                  |
...
int start() {
   ...
   sma10_1 = iMA(NULL, 0, smaShort, 0, MODE_SMA, PRICE_CLOSE, 1); // c
   sma10_2 = iMA(NULL, 0, smaShort, 0, MODE_SMA, PRICE_CLOSE, 2); // b
   sma40_1 = iMA(NULL, 0, smaLong, 0, MODE_SMA, PRICE_CLOSE, 1); // d
   sma40_2 = iMA(NULL, 0, smaLong, 0, MODE_SMA, PRICE_CLOSE, 2); // a
    
   atrCur = iATR(NULL,0,atrPeriod,1);
   atrOld = iATR(NULL,0,atrPeriod,atrShift);
